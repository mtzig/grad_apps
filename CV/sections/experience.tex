...
\innerlist{
	...
	\entryextra{Focused on reproducability and robustness  of counterfactually fair training methods}
	\entryextra{Evaluated results over a 1D-CNN and DistillBert}
}
...
\entrybig
	{\textbf{Carleton College}}{Northfield, MN}
	{Student Researcher with Professor David Lieben-Nowell}{Winter 2021-Current}
\innerlist{
	\entry{Used Choice Modeling to discover underlying patterns about how people choose}
	\entryextra{Built various models based on different assumptions trained on a ground-truthless dataset of human rankings of American state}
