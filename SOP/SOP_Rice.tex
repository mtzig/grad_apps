...
Therefore, I am applying to Rice University with an interest in working with Professor Xia ``Ben'' Hu in the D2K lab and Professor Vicente Ordóñez-Román in the Vislang lab. Professor Hu's lab has done much work in fairness and interpretability -- specifically with graph neural networks such as structured interpretability in \cite{yuan2021towards} and topology bias in \cite{jiang2022fmp}. His lab also has a more general focus on fairness and explainability such as an overview of fairness in healthcare \cite{feng2022fair} or a study on the effects of explanation detail on human performance \cite{linder2021level}.
Professor Ordóñez-Román's lab similarly appeals to me with its focus on explainability such as saliency maps in \cite{petsiuk2021black} and fairness with gender-seniority bias \cite{honnavalli2022towards}. I also find the labs work on multimodal models such as \cite{yang2022backpropagation} interesting.
By working in either the D2K lab or the Vislang lab, I can contribute with my knowledge of deep learning frameworks and experience working with fairness problems. Through these lab, I also aim to further my own goals of eventually working on explainable and fair machine learning models.

% ashok
% Vicente Ordóñez-Román
    % Black-box Explanation of Object Detectors via Saliency Maps
    % Towards Understanding Gender-Seniority Compound Bias in Natural Language Generation
    % Backpropagation-Based Decoding for Multimodal Machine Translation -- work in multimodal models
% Xia “Ben” Hu
    ...
    % FMP: Toward Fair Graph Message Passing against Topology Bias (Topology bias)
