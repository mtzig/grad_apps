...
% swap the oder of below two sentences?
...
% Focus on fairness in computer vision aligns with my own research aims.
% \cite{meister2022gender} \cite{kim2022help}
...
% By working in the Princeton NLP Group, I can contribute
% Through these lab, I also aim to further my own goals 

% OLGA RUSSAKOVSKY
    % REVISE: A tool for measuring and mitigating bias in visual datasets (66 cite) \cite{wang2022revise}
